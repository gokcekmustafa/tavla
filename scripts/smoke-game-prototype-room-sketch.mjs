...
const checks = [
  {
    ...
    test: () =>
      ...
      && hasApp("const okeyPrototypeActiveFilterLabels = useMemo(() => {")
  ...
  },
  {
    ...
    test: () =>
      ...
      && hasApp("className=\"my-game-coming-table-sketch-filter-chip\"")
  ...
  },
  {
    ...
    test: () =>
      ...
      && hasCss(".my-game-coming-table-sketch-filter-chip {")
