...
const checks = [
  ...
  },
  {
    ...
    test: () =>
      ...
      && hasApp("className={`my-game-coming-prototype-rack-tile tile-${tile.color} ${okeyPrototypeDiscardDraftTileId === tile.id ? \"selected\" : \"\"}`}")
  ...
  },
  {
    ...
    test: () =>
      ...
      && hasCss(".my-game-coming-prototype-rack-tile.selected {")
